...
#define NUD_ARGS Token_enum tkn_type, Lexer &lexer, Ast &ast, Ast_node* left, Ast_node* super
#define LED_ARGS Token_enum tkn_type, Lexer &lexer, Ast &ast, Ast_node* left, Ast_node* super
...
struct Semantic_code {
    ...
    // bool (*led_req)(LED_REQ_ARGS) = led_req_nil;
};
...
consteval std::array<Semantic_code, tkn_SIZE> get_op_semantics_table() {
    ...
    table[tkn_from_imp]    = {6, 5, nud_error, led_normal};
    table[tkn_to_imp]      = {6, 6, nud_error, led_normal};
    table[tkn_not_from]    = {6, 5, nud_error, led_normal};
    table[tkn_not_to]      = {6, 6, nud_error, led_normal};
    table[tkn_func_body]   = {6, 6, nud_error, led_normal};
    table['=']             = {7, 7, nud_error, led_normal};
    table[tkn_update_add]  = {7, 7, nud_error, led_normal};
    table[tkn_update_sub]  = {7, 7, nud_error, led_normal};
    table[tkn_update_mul]  = {7, 7, nud_error, led_normal};
    table[tkn_update_div]  = {7, 7, nud_error, led_normal};
    table[tkn_increment]   = {7, 7, nud_error, led_normal};
    table[tkn_decrement]   = {7, 7, nud_error, led_normal};
 			      	    
    table[tkn_or]          = {8, 8, nud_error, led_normal};
    table[tkn_and]         = {9, 9, nud_error, led_normal};
    table[tkn_eq]          = {10, 10, nud_error, led_normal};
    table[tkn_neq]         = {10, 10, nud_error, led_normal};
    table['<']             = {10, 10, nud_error, led_normal};
    table['>']             = {10, 10, nud_error, led_normal};
    table[tkn_less_eq]     = {10, 10, nud_error, led_normal};
    table[tkn_greater_eq]  = {10, 10, nud_error, led_normal};
    table['+']             = {11, 11, nud_right, led_normal};
    table['-']             = {11, 11, nud_right, led_normal};
    table['*']             = {12, 12, nud_error, led_normal};
    table['/']             = {12, 12, nud_error, led_normal};
    table['%']             = {12, 12, nud_error, led_normal};
    table[tkn_pow]         = {14, 13, nud_error, led_normal};
    table['!']             = {15, 15, nud_right};
    ...
    table['\\']            = {19, 19, nud_error, led_normal};
    table['|']             = {0, 20, nud_right};
    table[tkn_extern]      = {0, 20, nud_right};
    table[tkn_exread]      = {0, 20, nud_right};
    table[tkn_exwrite]     = {0, 20, nud_right};
    table[tkn_exlayout]    = {0, 20, nud_right};
    table[tkn_AoS]         = {0, 21, nud_right}; // require exlaout be the super
    table[tkn_SoA]         = {0, 21, nud_right}; // require exlaout be the super
...
Ast_node* nud_left(NUD_ARGS) {
    ...
    Ast_node* node = new Ast_node{lexer.tkn_at(0)};
...
Ast_node* nud_ident(NUD_ARGS) {
    ...
    node->id = ast.find_or_add_ident(node);
    return node;
}
